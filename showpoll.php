...
?>
      ...
      <td><input type="text" name="option1" value="<?php echo $value[0]; ?>"><br/><br/></td>
      <td><input type="text" name="option2" value="<?php echo $value[1]; ?>"><br/><br/></td>
      <td><input type="text" name="option3" value="<?php echo $value[2]; ?>"><br/><br/></td>
      <td><input type="text" name="option4"  value="<?php echo $value[3]; ?>"><br/><br/></td>
      <td>

...
//
   ...
   if($run==true)
   {
      ...
      ?>
         ...
         <td><?php echo $data['Question']; ?><br/><br/></td>
         <td><?php echo $option_s[0]; ?><br/><br/></td>
         <td><?php echo $option_s[1]; ?><br/><br/></td>
         <td><?php echo $option_s[2]; ?><br/><br/></td>
         <td><?php echo $option_s[3]; ?><br/><br/></td>
         ...
         <td><a href="showpoll.php?edit_id=<?php echo $data['id'];?>&status=<?php echo $data['Is_active'];?>&page=<?php echo $currentPage ?>">
         <?php 
          if($data['Is_active']==0){
            echo 'activate';
        ...
        <td><?php echo $data['created time']; ?><br/><br/></td>
        <td><?php echo $data['last edit']; ?><br/><br/></td>
         ...
         <?php
            ...
            <td><input type="text" name="question" value="<?php echo $data['Question']; ?>" ><br/><br/></td>
            <td><input type="text" name="option1" value="<?php echo $option_s[0]; ?>"><br/><br/></td>
            <td><input type="text" name="option2" value="<?php echo $option_s[1]; ?>"><br/><br/></td>
            <td><input type="text" name="option3" value="<?php echo $option_s[2]; ?>"><br/><br/></td>
            <td><input type="text" name="option4"  value="<?php echo $option_s[3]; ?>"><br/><br/></td>
            <td>
      ...
      <?php if($currentPage >= 2) { ?>
        <li style="display: inline;"class="page-item"><a class="page-link" href="?page=<?php echo $previousPage ?>">
        <?php echo $previousPage ?></a></li>
        <?php } ?>
        <li style="display: inline;" class="page-item active"><a class="page-link" href="?page=<?php echo $currentPage ?>"><?php echo $currentPage ?></a></li>
        <?php if($currentPage != $lastPage) { ?>
          <li style="display: inline;" class="page-item"><a class="page-link" href="?page=<?php echo $nextPage ?>"><?php echo $nextPage ?></a></li>
          <li style="display: inline;" class="page-item">
